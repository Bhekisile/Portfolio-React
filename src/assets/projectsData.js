const projectsData = [
  ...
  },
  {
    ...
    projectDescription: 'The project is about university activity, it contains lecturers and the modules related to them. The students can register their credentials and start using this app. Liking of the professors is available only for the login user.',
